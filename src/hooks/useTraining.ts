/*
useTraining permet de récupérer les informations d'un apprentissage en cours.
...
Le hook effectue une requête à l'API toutes les 1 secondes pour mettre à jour les informations de l'apprentissage.

amelioration:
on devrait avoir un moyen d'arrêter de faire un fetch toutes les 1 secondes une fois que l'apprentissage est fini
*/
